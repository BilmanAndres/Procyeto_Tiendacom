...
INSERT INTO `usuarios` VALUES (12,'dd','23444','dfff@hsk','gfg',1,12,'123','123','2000-11-10');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `into_factu_com_prod`(in idfac_co_pro int, in idfac_co int, in idPro int, in cant_com int, in precio_uni int, in pre_tot int)
BEGIN
insert into factu_com_prod values(idfac_co_pro, idfac_co, idPro, cant_com, precio_uni, pre_tot );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `into_fact_com`(in idf_com int, in idPro int, in idUs int, in des float, in tipo_pag varchar (45))
BEGIN
insert into fact_com (idfact_com, idProvedores,idUsuarios,fecha, total_compra, descuento, tipo_de_pago ) values (idf_com, idPro, idUs, (current_timestamp()), '0', des, tipo_pag);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `into_producto`(in idpro int, in nom varchar (250), in descri varchar (250), in ima varchar (250), in pres float)
BEGIN
insert into producto (idProducto, nombre, descripcion, imagen, precio, condicion) values (idpro, nom, descri, ima, pres, '1');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `into_provedores`(in idprov int, in nit varchar (45), in nom varchar (250), in idsex int, in corr varchar (250), in tele varchar (10), in direc varchar (50), in ti_po varchar (45), in act varchar(45), fech_naci date )
BEGIN
insert into provedores values (idprov,nit,nom, idsex, corr, tele, direc, ti_po, act, fech_naci );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `into_usuario`(in idUsu int, in nom varchar (250), in telef varchar (15), in corr varchar (250), in direc varchar (250), in idsex varchar (50), in idcarg int, in logi varchar (7), in clav varchar (7), in fech_naci date)
BEGIN
insert into usuarios values (idUsu, nom, telef, corr, direc, idsex, idcarg, logi, clav, fech_naci);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-10-17  9:49:10
